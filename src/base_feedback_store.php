...
* @version $Id: base_feedback_store.php 39517 2014-03-04 18:51:22Z weinert $
*/
...
class base_feedback_store extends base_db {
  ...
  */
   ...
   * @var array
   */
  public $feedbackData = array();

  /**
   * @var array
   */
  public $feedbackFormsData = array();

  /**
   * @var array
   */
  public $feedbackDetail = array();
