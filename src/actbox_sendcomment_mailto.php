...
* @version $Id: actbox_sendcomment_mailto.php 39517 2014-03-04 18:51:22Z weinert $
*/
...
* @subpackage Free-Mail
*/
class actionbox_sendcomment_mailto extends base_actionbox {
  ...
  */
  var $editFields = array(
    'title' => array('Link Title', 'isNoHTML', FALSE, 'input', 200, '', 'send comment'),
    'mailto' => array('Target Email', 'isEmail', FALSE, 'input', 200, '', 'you@localhost'),
